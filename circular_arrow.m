function all = circular_arrow(axes1, radius, centre, arrow_angle, angle, direction, colour, head_size, head_style)
...
while i < 3
    ...
    pl(i) = plot(v{i}(1,:)+xc,v{i}(2,:)+yc,'Color', colour); % Plot arc, centered at P0
...
while i < abs(direction) + 1
    ...
    set(h(i),'parent', gca, 'position', position{i}, ...
